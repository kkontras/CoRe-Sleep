...
sys.path.insert(0, '/users/students/r0588842/Python/library')
import Neureka.library.nedc
import Neureka.library.preprocess
...
base_directory = '/esat/biomeddata/Neureka_challenge/IClabel/Neureka/edf/dev' # Path to directory with EDF files
save_path = '/esat/biomeddata/guests/DriesVanHemelen/Data_edf_ICA.h5' # Path to file containing the loaded data structure
