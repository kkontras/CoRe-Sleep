...
import Neureka.library.loading
...
base_directory = '/esat/biomeddata/Neureka_challenge/edf/dev/' # Path to directory with EDF files
save_path = '/esat/biomeddata/guests/DriesVanHemelen/Data_edf_Wiener.h5' # Path to file containing the loaded data structure
