...
class U2NETP(nn.Module):
    ...
    def __init__(self,in_ch=1,out_ch=1):
        ...
        # self.pool45 = nn.MaxPool2d(2,stride=2,ceil_mode=True)
        #
        # self.stage5 = RSU4F(32,16,32)
        # self.pool56 = nn.MaxPool2d(2,stride=2,ceil_mode=True)

        self.stage6 = RSU4F(32,16,32)

        # decoder
        # self.stage5d = RSU4F(64,16,32)
    ...
    def forward(self,x):
        ...
        hx3d = self.stage3d(torch.cat((hx6up,hx3),1))
        hx3dup = _upsample_like(hx3d,hx2)
        ...
        return F.sigmoid(d0), F.sigmoid(d1), F.sigmoid(d2), F.sigmoid(d3), F.sigmoid(d6)