...
class DataGeneratorWrapper:
    def __init__(self, eeg_filelist=None, eog_filelist=None, emg_filelist=None, num_fold=1, data_shape_1=np.array([3000]), data_shape_2=np.array([29, 129]), seq_len = 20, shuffle=False):
